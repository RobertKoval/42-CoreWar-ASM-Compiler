...
static int	ft_write_app4(t_application *app, t_token *a, size_t app_size)
{
	int		null;
	char	*strings;
...
static void	ft_write_app3(t_application *app, t_token *a, size_t *app_size)
{
...
static void	ft_write_app2(t_application *app, t_token *a, size_t *app_size)
{
	int		bi;
	short	bs;
...
void		ft_write_app(t_application *app)
{
	...
	while (a)
	{
		if (ft_write_app4(app, a, app_size))
			;
